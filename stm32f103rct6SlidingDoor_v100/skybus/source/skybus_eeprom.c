...
/** @group skybus_EEPROM_INIT
    @{
*/#ifndef skybus_EEPROM_INIT
#define skybus_EEPROM_INIT

/** @brief ham cai dat thu vien eeprom stm32f103
    @return dia chi con tro eeprom
*/
skybus_eeprom_t* skybus_eeprom_init(void)
{
    /// cap cung nho cho thu vien
    eeprom = calloc(sizeof(skybus_eeprom_t), 1);
    /// init eeprom
    HAL_FLASH_Unlock();
    ...
    eeprom->write = EE_WriteVariable;
    eeprom->read  = EE_ReadVariable;
    
    return eeprom;
}
/** @brief ham tra ve dia chi thu vien eeprom stm32f103
    @return dia chi con tro eeprom
*/
skybus_eeprom_t* eeprom_(void)
{
    return eeprom;
}
#endif
